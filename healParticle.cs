...
{
    internal class healParticle : Entity
    {
        ...
        public healParticle(CollisionCheck check, Player player, ParticleManager particleManager, int size, float mana)
        {
            id = 9888;
            this.player = player;
            this.check = check;
        ...
        public override void draw(SpriteBatch _spriteBatch)
        {
            ...
            _spriteBatch.Draw(texture, drawrect, croprect, Color.Yellow, 0, Vector2.Zero, spriteEffects, 1);
